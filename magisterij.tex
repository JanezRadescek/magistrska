...
odhajajoči signal. Vsebuje operacijo, pripadajoči tovor in 
prihajajoči signal
prestreznik
blokada


Pripadajočo sintakso vidimo na sliki~\ref{fig:vrednosti} v Backus-Naurjevi obliki (BNF).

\jR{zakaj imajo funkcije sintakso za tip? Ali niso anotacije v ta namen??}
