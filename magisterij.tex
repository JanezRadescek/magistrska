...
%recursion = rekurzija
%bidirectional = izmenjujočim /      dvostranski se lepše sliši?
...
Eden izmed njih je tudi jezik \aeff, ki sloni na računu imenovanem \lae~\cite{aeff}. Čepravi ma veliko lepih lastnostih pa še vedno potrebuje določene popravke in implementacije.
...
\section{Nove funkcionalnosti}\label{sec:nove-strukture}
