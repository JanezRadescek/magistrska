...
Kadar pričakujemo več signalov istega \jr{imena?} je lahko iz različnih razlogov za programerja priročno, če ima na voljo promise, ki se po potrebi ponovno namesti. Lahko da je namen promisa, da na vsakega sproži določene učinke. Lahko nam prihajajoči signal prinese pravo operacijo, vendar ne prave pripadajoče vrednosti zato promisa še nočemo izpolniti, in čakamo na naslednjega.

To funkcionalnost smo do sedaj dosegli tako, da smo promise zapakirali v rekurzivno funkcijo. Sedaj lahko promise poimenujemo in znotraj promisa direktno ustvarimo novo kopijo promisa.  
