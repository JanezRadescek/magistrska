...
%organizirano.
V delu si pogledamo programski jezik \aeff{} in \lae{}-račun na katerem temelji. Glavna lastnost \lae{}-računa je možnost asinhronega izvajanja v navezi z vzporednim izvajanjem. To dosežemo tako, da ko prestreznik čaka, da dobi odgovor v obliki efekta iz drugega procesa, naprej izvaja svoje nadaljevanje. Ko prestreže želeni efekt ga primerno obdela in izvajanje se spet nadaljuje. Osnovno verzijo \lae{}-računa razširimo z rekurzivnimi obljubami, mobilnimi tipi in dinamičnimi procesi. Rekurzivne obljube omogočijo, da bo program lahko reagiral na več efektov z istim imenom operacije. Mobilni tipi omogočijo pošiljanje funkcij, ki jih prej nismo mogli. Dinamični procesi pa omogočijo ustvarjanje novih procesov sproti po potrebi. 
Dokažemo izreka o napredku in ohranitvi za osnovni in razširjen \lae{}-račun.
Omenimo tudi nekatere razlike med teoretično in implementirano verzijo.
