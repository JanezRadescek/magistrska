...
\begin{proof}
	\begin{itemize}
		...
		Če je $\tyC$ oblike $\typar{D_1}{D_2}$, potem lahko po indukcijski predpostavki $D_1$ in $D_2$ naredita korak v $\opincomp{op}{D_1}$ in $\opincomp{op}{D_2}$. Skupaj s pravilom \rulename{TyRedu-Par} velja $C = \typar{D_1}{D_2} \reduces \typar{\opincomp{op}{D_1}}{\opincomp{op}{D_2}} = \opincomp{op}{\typar{D_1}{D_2}} = C$.
		...
		Skupaj s pravilom \rulename{TyRedu-Par} velja $\opincomp{op}{\tyC} = \opincomp{op}{\typar{D_1}{D_2}} = \typar{\opincomp{op}{\tyD_1}}{\opincomp{op}{\tyD_2}} \reduces \typar{\opincomp{op}{\tyD_1'}}{\opincomp{op}{\tyD_2'}} = \opincomp{op}{\typar{D_1'}{D_2'}} = \opincomp{op}{\tyC'}$.
	\end{itemize}
\end{proof}
