...
\begin{proof}
	...
	\begin{enumerate}
		...
		Naj bo $\i(op) = (\o'',\i'')$. Tedaj sta iskana $\o'''$ in $\i'''$ iz definicije ravno $\o''$ in $\i''$. $\o''\order{O}\o''$ velja, ker je $\order{O}$ delna urejenost. $\i'' \order{I} \i''$ velja po indukcijski predpostavki.
		
		\item Naj bo $\i(op) = \bot$. Ker je $\i' \order{I} \i$, mora veljati $\i'(op) = \bot$.
		Naj bo $\i(op) = (\o'', \i'')$ in $\i'(op) = (\o''',\i''')$. Ker velja $\i \order{I} \i' \wedge \i' \order{I} \i$, velja $\o'' \order{O} \o''' \wedge \o''' \order{O} \o''$. Ker je $\order{O}$ delna urejenost, velja $\o'' = \o'''$. Ker velja $\i'' \order{I} \i''' \wedge \i''' \order{I} \i''$, po indukcijski predpostavki velja $\i'' = \i'''$.
		...
		Naj bo $\i_1(op) = (\o_1', \i_1')$. Ker je $\i_1 \order{I} \i_2$, mora biti $\i_2(op) = (\o_2', \i_2')$. Po istem razmisleku je $\_3(op) = (\o_3', \i_3')$. Ker je $\order{O}$ delna urejenost, velja $\o_1' \order{O} \o_3'$. Po indukcijski predpostavki velja tudi $\i_1' \order{I} \i_3'$.
		
	\end{enumerate}
\end{proof}


Sledeča lema pravi da $\cup$ na $I$ spoštuje $\order{I}$.
...
\begin{proof}
	V pogoju definicije urejenosti ločimo dva primera. Za $\op$ za katere velja $i(op) = \bot$, je pogoj na prazno izpolnjen. Poglejmo sedaj tiste $\op$ za katere velja $\i(op) = (\o'', \i'')$. 
