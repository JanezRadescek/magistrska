...
\begin{izrek}[Izrek o napredku za izračune]
	Naj za izračun $M$ velja $\Gamma \types M \of \tycomp{A}{\o, \i}$. Potem ali (i) obstaja izračun $N$, tak da $M \reduces N$, ali pa (ii) velja $\RunResult{\emptyset}{M}$.
\end{izrek}

\begin{izrek}[Izrek o napredku za procese]
	Naj za proces $M$ velja $\Gamma \types M \of C$. Potem ali (i) obstaja proces $N$, tak da $M \reduces N$, ali pa (ii) velja $\ProcResult{M}$.
\end{izrek}
