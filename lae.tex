...
Dodatno definiramo operacijo $\opincompp{ops}{}$. Ker imamo evalvacijo v okolju in se lahko zgodi da nova operacija pride od znotraj.
...
\begin{figure}[H]
	...
	\begin{mathpar}
		...
		\coopinfer{TyRedu-Change}{
			...
			\tyrun{A}{\opincomp{op}{(\o, \i)}} \tyreduces \tyrun{A}{\opincomp{op}{(\o', \i')}}
		}
%		\coopinfer{TyRedu-Change}{
%		}{
...
\begin{proof}
	...
	\begin{itemize}
		...
		Po indukcijski predpostavki ima $Q'$ tip $C'$.
		Po pravilu \rulename{TyProc-Interrupt} ima $\tmopin{op}{V}{Q'}$ tip $\opincomp{op}{C'}$, kjer je $C$ naredil korak \rulename{TyRedu-Change}.
	\end{itemize}
