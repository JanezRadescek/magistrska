...
Sledeča lema pravi da $\cup$ na $I$ spoštuje $\order{I}$ in $I$ je join-semilattice.
...
\begin{proof}
	\begin{enumerate}
		...
		Naj bo sedaj $\i_1(\op) = (\o_1', \i_1')$ in $\i_2(\op) = (\o_2', \i_2')$ in $\i_3(\op) = (\o_3', \i_3')$. Ker je $O$ z $\order{O}$ join-semilattice velja $(\o_1' \cup \o_2') \order{O} \o_3'$. Ker je $\i_1' \order{I} \i_3'$ in $\i_2' \order{I} \i_3'$ je po indukcijski predpostavki $(\i_1' \cup \i_2') \order{I} \i_3'$.
	\end{enumerate}
