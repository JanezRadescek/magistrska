...
\begin{proof}
	\begin{itemize}
		...
		\item \rulename{TyRedu-Add} : Če je $\tyC$ oblike $\tyrun{A}{\o,\i}$, potem $\tyC = \tyrun{A}{\opincompp{ops}{(\o, \i)}} \tyreduces \tyrun{A}{\opincompp{ops}{(\opincomp{op}{(\o, \i)})}} = \opincomp{op}{\tyC}$ za $\mathsf{ops} = []$.
