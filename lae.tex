...
%Kaj naj z kontekstom? Naj ga vedno pišem, samo kadar ni očiten???
%Kaj naj z napredkom? Naredi tudi tip korak v ???

\begin{lema}\label{lem:strengthening-gamma}
	Naj velja $\Gamma_1, x \of A, \Gamma_2 \types y \of B$ za $y \neq x$. Potem velja $\Gamma_1, \Gamma_2 \types y \of B$.
\end{lema}
...
\begin{proof}
	...
	Za osnovni primer imamo več možnosti, ki jih ločimo glede na uporabljeno pravilo.
	\begin{itemize}
		\item Če je uporabljeno pravilo \rulename{Ty-Cons-N}, potem je $W$ enak $n$ in $B$ enak $int$. Ker je $n[V/x] = n$, ima $W[V/x]$ tip $int = B$.
		\item Če je uporabljeno pravilo \rulename{Ty-Cons-T}, potem je $W$ enak $true$ in $B$ enak $bool$. Ker je $true[V/x] = true$, ima $W[V/x]$ tip $bool = B$. 
		\item Če je uporabljeno pravilo \rulename{Ty-Cons-F}, potem je $W$ enak $false$ in $B$ enak $bool$. Ker je $false[V/x] = false$, ima $W[V/x]$ tip $bool = B$.
		\item Če je uporabljeno pravilo \rulename{Ty-Var}, potem je $W$ enak $a$. Ločimo dva primera.
		\begin{itemize}
			\item Če je spremenljivka $a = x$, potem je $a[V/x] = V$. Ker je $B = A$, je tip $W[V/x] = V$ enak $B$.
			\item Če je spremenljivka $a \neq x$, potem je $W[V/x] = a$. Po lemi~\ref{lem:strengthening-gamma} ima $a$ tip $B$.
		\end{itemize}
	...
	\begin{itemize}
		...
		\item Če je zadnje pravilo \rulename{Ty-Promise}, ... ???
