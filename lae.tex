...
Najpreprostejši primer je ko imamo dva vzporedna zagona.
...
Potencialno spremembo tipa formaliziramo z pravili za splošen tip procesa, ki jih lahko vidimo na sliki~\ref{fig:process-type-reductions}.
...
%	\vspace{-5ex}
%	\caption{Pravila za spremembo osnovnih tipov.}
%	\label{fig:process-type-reductions-gener}
%\end{figure}
