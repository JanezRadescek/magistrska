...
\begin{proof}
	\begin{enumerate}
		...
		Naj bo sedaj $\i_1(\op) = (\o_1', \i_1')$. Ker je $\i_1 \order{I} \i_2$, mora biti $\i_2(\op) = (\o_2', \i_2')$. Po istem razmisleku je $\_3(\op) = (\o_3', \i_3')$. Ker je $\order{O}$ delna urejenost, velja $\o_1' \order{O} \o_3'$. Po koindukcijski predpostavki velja tudi $\i_1' \order{I} \i_3'$.
