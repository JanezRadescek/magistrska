...
\begin{lema}\label{lem:weakening}
	Naj za vrednost $V$ velja $\Gamma_1, \Gamma_2 \types V \of B$. Če $x \neq \Gamma_1$ in $x \neq \Gamma_2$, potem velja $\Gamma_1, x \of A, \Gamma_2 \types V \of B$.
\end{lema}
...
\begin{lema}\label{lem:inversion-lema}
	...
	\begin{itemize}
		...
		\item Če je $M$ oblike $\tmlet{x}{N_1}{N_2}$, potem velja $\Gamma \types N_1 \of \tycomp{B}{\o'', \i''}$, $\Gamma \types N_2 \of \tycomp{A}{\o', \i'}$ in $(\o'', \i'') \order (\o, \i)$.
...
\begin{proof}
	...
	\begin{itemize}
		...
		Po lemi~\ref{lem:weakening} ima $N_3$ isti tip tudi v večjem kontekstu.
		...
		Po lemi~\ref{lem:weakening}, ima $V$ tudi v razširjenem kontekstu isti tip.
