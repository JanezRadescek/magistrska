...
Nova vrednost je \emph{obljuba}. Je vrednost, ki jo je vrnil prestreznik in jo posebej označimo, da ji lažje pravilno določimo tip.
...
Ko izračun od zunaj dobi novo prekinitev, se mu lahko spremeni tip učinkov.
...
\begin{proof}
	...
	\begin{itemize}
		...
		Lahko naredimo korak v $M[W/x]$ ali $M[V/x, (\tmfunrec{f}{x \of X}{M})/f]$.
