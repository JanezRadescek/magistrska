...
\begin{figure}[H]
	...
	\begin{mathpar}
		...
		\coopinfer{TyRedu-Add-Basic}{
			...
			\tyrun{A}{\opincomp{ops}{(\o, \i)}} \tyreduces \tyrun{A}{\opincomp{ops}{(\opincomp{op}{(\o, \i)})}}
		}
		\\
...
\begin{proof}
	\begin{itemize}
		\item \rulename{TyRedu-Same} : Če je $\tyC$ oblike $\tyrun{A}{\o,\i}$, potem $\tyC = \tyrun{A}{\o,\i} \tyreduces \tyrun{A}{\o,\i} = \tyC$.
		Če je $\tyC$ oblike $\typar{D_1}{D_2}$, potem lahko po indukcijski predpostavki $D_1$ in $D_2$ naredita korak v $D_1$ in $D_2$. Torej velja $C = \typar{D_1}{D_2} \reduces \typar{D_1}{D_2} = C$.
		
		\item \rulename{TyRedu-Add} : Če je $\tyC$ oblike $\tyrun{A}{\o,\i}$, potem $\tyC = \tyrun{A}{\opincomp{ops}{(\o, \i)}} \tyreduces \tyrun{A}{\opincomp{ops}{(\opincomp{op}{(\o, \i)})}} = \opincomp{op}{\tyC}$ za $\mathsf{ops} = []$.
		Če je $\tyC$ oblike $\typar{D_1}{D_2}$, potem lahko po indukcijski predpostavki $D_1$ in $D_2$ naredita korak v $D_1' = \opincomp{op}{D_1}$ in $D_2' = \opincomp{op}{D_2}$. Torej velja $C = \typar{D_1}{D_2} \reduces \typar{D_1'}{D_2'} = \opincomp{op}{\typar{D_1}{D_2}} = C$.
		
		\item \rulename{TyRedu-Change} : Če je $\tyC$ oblike $\tyrun{A}{\o,\i}$, potem je $\tyC$ lahko naredil le korak v $\tyC$ in torej $\opincomp{op}{\tyC} = \tyrun{A}{\o',\i'} \tyreduces \tyrun{A}{\o',\i'} = \opincomp{op}{\tyC}$.
		...
		Torej velja $\opincomp{op}{\tyC} = \opincomp{op}{\typar{D_1}{D_2}} = \typar{\opincomp{op}{\tyD_1}}{\opincomp{op}{\tyD_2}} \reduces \typar{\opincomp{op}{\tyD_1'}}{\opincomp{op}{\tyD_2'}} = \opincomp{op}{\typar{D_1'}{D_2'}} = \opincomp{op}{\tyC'}$.
	\end{itemize}
\end{proof}
