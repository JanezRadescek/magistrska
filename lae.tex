...
\mP{Ali veš, zakaj ta fiksna točka obstaja?}
...
Kako točno se spremenijo efekti definira $\opincomp{op}{(\o, \i)}$.
...
S pomočjo sledeča leme lahko vseeno deloma uporabimo ustrezne predpostavke, čeprav v nekoliko šibkejši obliki.
