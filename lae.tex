...
\begin{proof}
	...
	\begin{itemize}
		\item Če je zadnje uporabljeno pravilo \rulename{TyComp-Subsume} potem ima $M$ tudi tip $\tycomp{A}{\o', \i'}$. Po $IP$ direktno na $M$ lema sledi, saj je $\order{O, I}$ tranzitiven.
		\item Sicer ločimo primere glede na obliko izračuna $M$.
		...TODO
	\end{itemize}
\end{proof}
