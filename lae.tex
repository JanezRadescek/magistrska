...
Običajno se izvaja nadaljevanje $N$, med tem ko preostali deli čakajo. Ko pride prekinitev z istim imenom operacije se spremenljivka $x$ substituira z tovorom $V$ v obljubi $M$. Nakar se prestreznik spremeni v zaporedje izračuna $M$ in prekinitve, ki ima za nadaljevanje izračun $N$. Rezultat izračuna $M$ bo vezan v spremenljivko $p$ in se ga tako lahko uporabi v $N$. Ko prestreznik ujame ustrezno prekinitev rečemo, da se je izpolnila obljuba $p$.
