...
Ker imamo sedaj v pravilu za tip prestreznika neenakost $(\o', \i') \order{O \times I} \i(\op)$, bomo lemo~\ref{lem:effects-order} dopolnili s sledečo lemo.
...
\begin{proof}
	...
	\begin{itemize}		
		...
		\begin{itemize}
			...
			in smo torej naredili korak \rulename{TyRedu-Spawn-L}.
