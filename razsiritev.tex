...
\begin{proof}
	...
	\begin{itemize}
		\item Če je zadnje pravilo \rulename{Ty-Var'}, potem je $V = x$ in velja $x \in \Gamma_1$ ali $x \in \Gamma_2$.
		Ker $\Gamma_3$ ne vsebuje $\bb$, velja $\Gamma_1, \Gamma_3, \Gamma_2 \types V \of A$ po pravilu \rulename{Ty-Var'}
...
\begin{proof}
	...
	\begin{itemize}
		\item Če je zadnje pravilo \rulename{Ty-Var'}, potem je $V = x$ in velja $x \in \Gamma_1$ ali $x \in \Gamma_2$.
		Tip $A$ je prenosljiv.
		Ker je $A$ prenosljiv tip velja $\Gamma_1, \Gamma_3, \Gamma_2 \types V \of A$ po pravilu \rulename{Ty-Var'}
		...
		\item Če je zadnje pravilo \rulename{Ty-Cons-N}, potem je $V = n$. Po pravilu \rulename{Ty-Cons-N} velja $\Gamma_1, \Gamma_3, \Gamma_2, \bb \types V \of A$.
		...
		Po pravilu \rulename{Ty-Pair} velja $\Gamma_1, \Gamma_3, \Gamma_2, \bb \types V \of A$.
		
		\item Če je zadnje pravilo \rulename{Ty-Promise}, potem je $V =\tmpromise{V'}$.
		Po $IP$ ima $V'$ isti tip v razširjenem kontekstu.
		Po pravilu \rulename{Ty-Promise} velja $\Gamma_1, \Gamma_3, \Gamma_2, \bb \types V \of A$.
		
		\item Če je zadnje pravilo \rulename{Ty-Inl}, potem je $V = \tminl{V_1}$.
		Po $IP$ ima $V_1$ isti tip v razširjenem kontekstu.
		Po pravilu \rulename{Ty-Inl} velja $\Gamma_1, \Gamma_3, \Gamma_2, \bb \types V \of A$.
		
		\item Če je zadnje pravilo \rulename{Ty-Inr}, potem je $V = \tminl{V_2}$.
		Po $IP$ ima $V_2$ isti tip v razširjenem kontekstu.
		Po pravilu \rulename{Ty-Inr} velja $\Gamma_1, \Gamma_3, \Gamma_2, \bb \types V \of A$.
		
		\item Če je zadnje pravilo \rulename{Ty-Fun}, potem je $V = \tmfun{x}{M}$.
		Po lemi~\ref{lem:weakening-comp-bb} ima $M$ isti tip v razširjenem kontekstu.
		Po pravilu \rulename{Ty-Fun} velja $\Gamma_1, \Gamma_3, \Gamma_2, \bb \types V \of A$.
		
		\item Če je zadnje pravilo \rulename{Ty-Fun-Rec}, potem je $V = \tmfun{x}{M}$.
		Po lemi~\ref{lem:weakening-comp-bb} ima $M$ isti tip v razširjenem kontekstu.
		Po pravilu \rulename{Ty-Fun-Rec} velja $\Gamma_1, \Gamma_3, \Gamma_2, \bb \types V \of A$.
...
\begin{proof}
	...
	\begin{itemize}
		...
		\item Zadnje pravilo ne more biti \rulename{Ty-Promise}, saj v tem primeru $A$ ni prenosljiv.
		...
		\item Zadnje pravilo ne more biti \rulename{Ty-Fun}, saj v tem primeru $A$ ni prenosljiv.
		
		\item Zadnje pravilo ne more biti \rulename{Ty-Fun-Rec}, saj v tem primeru $A$ ni prenosljiv.
...
\begin{proof}
	...
	\begin{itemize}
		\item Če je zadnje pravilo \rulename{Ty-Var'}, potem je $V = x$. Ker je na koncu konteksta $\bb$ mora biti $B$ prenosljiv tip. Ker $\typromise{A}$ ni prenosljiv tip, velja $x \in \Gamma_1$ ali $x \in \Gamma_2$.
		...
		\item Če je zadnje pravilo \rulename{Ty-Cons-N}, potem je $V = n$.Po pravilu \rulename{Ty-Cons-N} velja $\Gamma_1, \Gamma_2, \bb \types V \of B$.
		...
		\item Če je zadnje pravilo \rulename{Ty-Promise}, potem je $V = \tmpromise{V'}$.
		Po $IP$ ima $V'$ isti tip v skrčenem kontekstu.
		Po pravilu \rulename{Ty-Promise} velja $\Gamma_1, \Gamma_2, \bb \types V \of B$.
		...
		\item Če je zadnje pravilo \rulename{Ty-Fun}, potem je $V = \tmfunano{x}{M}$.
		Po lemi~\ref{lem:strengthening-comp-bb} ima $M$ isti tip v skrčenem kontekstu.
		Po pravilu \rulename{Ty-Fun} velja $\Gamma_1, \Gamma_2, \bb \types V \of B$.
		
		\item Če je zadnje pravilo \rulename{Ty-Fun-Rec}, potem je $V = \tmfunrecano{f}{x}{M}$.
		Po lemi~\ref{lem:strengthening-comp-bb} ima $M$ isti tip v skrčenem kontekstu.
		Po pravilu \rulename{Ty-Fun-Rec} velja $\Gamma_1, \Gamma_2, \bb \types V \of B$.
...
\begin{proof}
	...
	\begin{itemize}
		\item Če je zadnje pravilo \rulename{Ty-Var'}, potem je $V = y$. Ker $\typromise{A}$ ni prenosljiv tip, velja $y \in \Gamma_1$ ali $y \in \Gamma_2$.
		Po pravilu \rulename{Ty-Var'} velja $\Gamma_1, \Gamma_2, \bb \types V \of B$.
		...
		\item Zadnje pravilo ne more biti \rulename{Ty-Promise}, saj v tem primeru $B$ ni prenosljiv.
		...
		\item Zadnje pravilo ne more biti \rulename{Ty-Fun}, saj v tem primeru $B$ ni prenosljiv.
		
		\item Zadnje pravilo ne more biti \rulename{Ty-Fun-Rec}, saj v tem primeru $B$ ni prenosljiv.
