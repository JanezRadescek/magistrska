...
\begin{proof}
	...
	\begin{itemize}		
		\item \rulename{TyRedu-Congruence} Dokazujemo s strukturno indukcijo na izpeljavo $\tyC \tyreduces \tyC'$.
		\begin{itemize}
			\item Če je zadnji korak $\tyrun{A}{\o, \i} \tyreduces \typar{\tyrun{A'}{\o', \i'}}{\tyrun{A}{\o, \i}}$, potem je $\opincomp{op}{\tyC} = \tyrun{A}{\o'', \i''} \reduces \typar{\tyrun{A'}{\o', \i'}}{\tyrun{A}{\o'', \i''}} = \typar{\tyC_L}{\opincomp{op}{\tyC}} = \opincomp{op}{\typar{\tyC_L'}{\tyC}} = \opincomp{op}{\tyC'}$ in smo torej naredili korak \rulename{TyRedu-Spawn-L}.
			
			\item Podobno če je zadnji korak \rulename{TyRedu-Spawn-R}.	
		\end{itemize}
	\end{itemize}
\end{proof}
